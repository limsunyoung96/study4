...
<body>
		...
		<table class="table table-striped table-bordered"> 
			<tbody>
				...
				<tr>
					<td colspan="2">
						<div class="pull-left">
							<a href="questionList.wow" class="btn btn-default btn-sm"> <span
								class="glyphicon glyphicon-list" aria-hidden="true"></span>
								&nbsp;&nbsp;목록
							</a>
						</div>
						<div class="pull-right">
							<a href="questionEdit.wow?boNo=${boardVo.boNo}"
	...
	// 상단에 전역변수 - 공통함수 - 이벤트함수 - 초기화처리
		var replyParam={"curPage":1, "rowSizePerPage":10,
							"reCategory":"FREE", "reParentNo":${boardVo.boNo}
							}
	 
		/* var curPage = 1;
		var rowSizePerPage = 10;
		var parentNo = ${boardVo.boNo};*/
