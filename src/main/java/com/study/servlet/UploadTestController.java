...
public class UploadTestController {
	...
	public String uploadResult(
			@RequestParam(name = "boFile", required = false) MultipartFile boFile,
		...
		if (boFile != null && !boFile.isEmpty()) {
			...
			//폴더가 존재하지 않으면 오류
			//boFile.transferTo(new File("/home/pc44/upload/2020/09/15/abc.zip"));
			FileUtils.copyInputStreamToFile(boFile.getInputStream(), new File("/home/pc44/upload/2020/09/15/abc.zip"));
		}
		// 테스트이므로 입력폼으로 리다이렉트
