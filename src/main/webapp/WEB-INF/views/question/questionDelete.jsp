...
<%@page import="com.study.question.service.QuestionServiceImpl"%>
<%@page import="com.study.question.service.IQuestionService"%>
...
<head>
	...
	<title>questionDelete.jsp </title>
</head>
<body>
 <div class="container">	
	<h3>글 삭제</h3>
	<jsp:useBean id="board" class="com.study.question.vo.QuestionBoardVO" />
	...
	%>
	<a href="questionList.jsp" class="btn btn-info btn-sm">
